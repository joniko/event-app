...
const LocationsTab: React.FC = () => {
  ...
  return (
    <div className="space-y-1 bg-yellow-700 sm:mx-auto sm:w-full max-w-4xl">
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-neutral-200">
              <TableHead className="text-yellow-700">Ubicación</TableHead>
              <TableHead className="text-yellow-700">Sábado</TableHead>
              <TableHead className="text-yellow-700">Domingo</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {workshopData.map((workshop, index) => (
              <TableRow key={index} className="border-neutral-200">
                <TableCell className="text-yellow-950 font-medium">
                  {workshop.location}
                </TableCell>
                <TableCell className="text-yellow-950">
                  {workshop.saturday}
                </TableCell>
                <TableCell className="text-yellow-950">
                  {workshop.sunday}
